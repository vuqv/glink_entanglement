            ...
            for residue in chain:
                if residue.get_resname() == 'CYS':
                    if 'SG' in residue:
                        ...
                        continue
                    # Check for disulfide bonds with distance threshold (e.g., <2.2 Ã)
                        ...
                        for chain2 in model2:
                            for residue2 in chain2:
                                if residue2.get_resname() == 'CYS' and residue != residue2:
                                    ...
                                    if distance < 2.2:
                                        print(f"Disulfide bond between {residue} and {residue2} at distance {distance:.2f} Ã")
...
if __name__ == "__main__":
    ...
    print(f'Runtime: {time.perf_counter() - total_start:.6f} seconds')
